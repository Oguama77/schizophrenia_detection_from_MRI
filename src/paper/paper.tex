...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{./figs/sample_volume.png} % test_pipeline.png
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.4\textwidth]{./figs/slice_comparison.png} % test_pipeline.png
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{./figs/model_architecture.png} % training_architecture.png
...
Rotation (2) further improved results, with the highest accuracy (0.79) and F1-score (0.80), alongside strong recall (0.81) and precision (0.78), demonstrating its ability to enhance both model robustness and overall performance.
